...
export function LmsCourseAboutPage() {
  const location = useLocation();
  const courseKey = useMemo(() => parseCourse(location.pathname), [location.pathname]);

  return (
    <main className="container legacy-v1-shell legacy-v1-generic legacy-v1-lms-course-about">
      <section className="legacy-v1-mast">
        <div>
          ...
          <p>LMS legacy course about page shell.</p>
        </div>
      </section>
      ...
      <section className="legacy-v1-layout legacy-v1-layout-mastless">
        <div className="legacy-v1-main">
          <section className="create-form">
            ...
            <p>This page corresponds to legacy LMS template: <code>courseware/course_about.html</code>.</p>
          </section>
        </div>
