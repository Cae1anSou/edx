...
- /api/team/v0/team_membership/test-team,
- /api/team/v0/team_memberships/
- /api/team/v0/teams/
- /api/team/v0/teams/%(teamId)s/assignments
- /api/team/v0/teams/no_such_team?expand=user
- /api/team/v0/teams/team_id
- /api/team/v0/teams/team_id/assignments
- /api/team/v0/teams/test-team
- /api/team/v0/topics/no_such_topic,course/1
- /api/team/v0/topics/topic_id,
...
- /api/v2/help_center/articles/search.json?query=${queryString}`,
- /api/v2/uploads.json?filename=`,
- /api/v2/uploads/${fileToken}.json`,
