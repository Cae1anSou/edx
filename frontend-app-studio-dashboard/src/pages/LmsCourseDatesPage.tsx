...
export function LmsCourseDatesPage() {
  const location = useLocation();
  const courseKey = useMemo(() => parseCourse(location.pathname), [location.pathname]);

  return (
    <main className="container legacy-v1-shell legacy-v1-generic legacy-v1-lms-course-dates">
      <section className="legacy-v1-mast">
        <div>
          ...
          <p>Legacy LMS dates schedule page shell.</p>
        </div>
      </section>
      ...
      <section className="legacy-v1-layout legacy-v1-layout-mastless">
        <div className="legacy-v1-main">
          <section className="create-form">
            ...
            <p>Mapped from legacy LMS route: <code>/courses/&lt;course&gt;/dates</code>.</p>
          </section>
        </div>
