...
public class LegacyAdditionalApiFamiliesController {
    ...
    public ResponseEntity<?> instructorV1() { return ResponseEntity.ok(Map.of("results", List.of())); }

    @GetMapping("/api/instructor/v2/")
    public ResponseEntity<?> instructorV2() { return ResponseEntity.ok(Map.of("results", List.of())); }
